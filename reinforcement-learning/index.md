...
| 章 | タイトル | 主な問い | 目安 (hour) | 内訳（読む / 演習・手を動かす / ノート） |
|---|---|---|---:|---|
| 1 | [MDP と TD 学習](01-mdp-and-td.md) | 状態・行動・報酬をどう定式化するか。価値とは何か | 12 | 6 / 4 / 2 |
| 2 | [方策勾配法](02-policy-gradient.md) | 方策を直接学ぶとはどういうことか。なぜ advantage と GAE が要るか | 9 | 4 / 3 / 2 |
| 3 | [PPO](03-ppo.md) | 重要度比とクリップは何を防いでいるか。設定値は何を決めているか | 12 | 5 / 5 / 2 |
| 4 | [オンポリシーとオフポリシー](04-on-policy-and-off-policy.md) | 違いは何か。どちらがどんな条件に向くか | 4 | 2 / 1 / 1 |
| 5 | [自己対戦と評価](05-self-play-and-evaluation.md) | 誰と戦わせ、何で強さを測るか | 6 | 3 / 2 / 1 |
| 6 | [模倣学習](06-imitation-learning.md) | BC はなぜ崩れるか。DAgger と蒸留は何を解くか | 6 | 3 / 2 / 1 |
| 7 | [24位の PPO 実装を読む](07-reading-24th-ppo.md) | 式とコードはどう対応するか | 9 | 4 / 4 / 1 |
| | 合計 | | 58 | 27 / 21 / 10 |

目安は、教材を読む時間、演習と「手を動かす」の課題に取り組む時間、ノートを書く時間の合計。
演習は、教科書（Sutton & Barto）の章末問題、Spinning Up の演習、各章の「確認」と「手を動かす」を指す。
学習を実際に長時間回す時間（PPO のサイクルを回すなど）は含まない。それは ptcg-abc 側のイシューで計画する。
1日3時間なら約20日（3週間弱）、1日1時間なら約2か月の見当。
章の区切りで見ると、1〜3章（PPO まで）で33時間、残りの4〜7章で25時間。
